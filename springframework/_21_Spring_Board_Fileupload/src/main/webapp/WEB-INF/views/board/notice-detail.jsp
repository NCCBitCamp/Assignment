        ...
        <div class="container mt-3 w-50">
            <form id="modify-form" action="/board/modify.do" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group mt-3">
                    ...
                    <input type="text" class="form-control" id="writer" name="writer" value="${notice.nickname}"
                           readonly>
                </div>
                <div class="form-group mt-3">
                ...
                <c:if test="${loginMember != null && loginMember.role == 'ADMIN'}">
                    <div class="container mt-3 mb-5 w-50 text-center">
                        ...
                        <button type="button" id="btn-delete" class="btn btn-outline-secondary ml-2"
                                onclick="location.href='/board/delete.do?id=${notice.id}&type=notice'">삭제
                        </button>
                    </div>
                </c:if>
            </form>
