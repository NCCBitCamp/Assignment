...
DECLARE
	...
	COURSEPROFREC COURSEPROF_REC;
BEGIN
	SELECT C.CNO
		 , C.CNAME
		 , C.PNO
		 , P.PNAME
		INTO COURSEPROFREC.CNO
		   , COURSEPROFREC.CNAME
		   , COURSEPROFREC.PNO
		   , COURSEPROFREC.PNAME
		FROM COURSE C
	...
	DBMS_OUTPUT.PUT_LINE(COURSEPROFREC.CNO);
	DBMS_OUTPUT.PUT_LINE(COURSEPROFREC.CNAME);
	DBMS_OUTPUT.PUT_LINE(COURSEPROFREC.PNO);
	DBMS_OUTPUT.PUT_LINE(COURSEPROFREC.PNAME);
END;
